...
class FStockOut extends Object{

	/**
	 * 数据库字段（只允许以下字段写入）
	 */
	protected $format_data = ['cid','sid','gid','gname','gcode','gbarcode','gspec','gunit','gtid','gtname','date','sell_total',
		'sell_amount','return_total','return_amount', 'transfer_total','transfer_amount'];

	//需要分和元转换的金额字段
	protected $amount_data = ['sell_amount','return_amount','transfer_amount'];
	...
	public function __construct($id = NULL){
		parent::__construct('f_stock_out', $id);
	}
